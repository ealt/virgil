...
- Release workflow now uses PAT to trigger downstream workflows
- Added manual trigger option to release workflow
...
[Unreleased]: https://github.com/ealt/virgil/compare/v0.1.3...HEAD
